...
def ui_tests_header():
    """ Эта функция """
    cmd = ["./scriptsh/ui_tests_header.sh"]
    with subprocess.Popen(cmd, stdout=subprocess.PIPE,
                          stderr=subprocess.PIPE,
                          stdin=subprocess.PIPE,
                          universal_newlines=True) as result:
...
def ui_tests_footer():
    """ Эта функция  """
    cmd = ["./scriptsh/ui_tests_footer.sh"]
    with subprocess.Popen(cmd, stdout=subprocess.PIPE,
                          stderr=subprocess.PIPE,
                          stdin=subprocess.PIPE,
                          universal_newlines=True) as result:
...
def ui_tests_main_page():
    """ Эта функция """
    cmd = ["./scriptsh/ui_tests_main_page.sh"]
    with subprocess.Popen(cmd, stdout=subprocess.PIPE,
                          stderr=subprocess.PIPE,
                          stdin=subprocess.PIPE,
                          universal_newlines=True) as result:
...
def ui_tests_list_of_cars():
    """ Эта функция  """
    cmd = ["./scriptsh/ui_tests_list_of_cars.sh"]
    with subprocess.Popen(cmd, stdout=subprocess.PIPE,
                          stderr=subprocess.PIPE,
                          stdin=subprocess.PIPE,
                          universal_newlines=True) as result:
...
def ui_tests_registration():
    """ Эта функция """
    cmd = ["./scriptsh/ui_tests_registration.sh"]
    with subprocess.Popen(cmd, stdout=subprocess.PIPE,
                          stderr=subprocess.PIPE,
                          stdin=subprocess.PIPE,
                          universal_newlines=True) as result:
...
def api_tests_status_code_get():
    """ Эта функция """
    cmd = ["./scriptsh/api_tests_status_code_get.sh"]
    with subprocess.Popen(cmd, stdout=subprocess.PIPE,
                          stderr=subprocess.PIPE,
                          stdin=subprocess.PIPE,
                          universal_newlines=True) as result:
...
def api_tests_status_code_post():
    """ Эта функция """
    cmd = ["./scriptsh/api_tests_status_code_post.sh"]
    with subprocess.Popen(cmd, stdout=subprocess.PIPE,
                          stderr=subprocess.PIPE,
                          stdin=subprocess.PIPE,
                          universal_newlines=True) as result:
